...
$(function qiyeKPI (){
    ...
    var arr = [60, 80, 73, 68, 5, 90, 80 ,89];
    var i = -1;

    // 基于准备好的dom，初始化echarts实例
    var myChart_qiyeKPI = echarts.init(document.getElementById('qiyeKPI'));
    charts.push(myChart_qiyeKPI);
    ...
    // 使用刚指定的配置项和数据显示图表。
    myChart_qiyeKPI.setOption(option);
