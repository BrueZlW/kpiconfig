...
function ajaxp() {
    $.ajax({
        url:"/person/getPKPIData",
        method:"post",
        data:{},
        success:function (data) {
            value_person={time_efficiency:0,standard_operation_compliance_rate:0};
            value_person=data;
        }
    })
}
...
function personChart4 (){
    ...
    setInterval(function () {
        option.series[0].data[0]=[value_person.time_efficiency.toFixed(2)];
...
function personChart7 (){
    ...
    setInterval(function () {
        option.series[0].data=[value_person.standard_operation_compliance_rate];
