$(function () {
    $.fn.FishBone = function (options) {
        var defaults = {
            ...
            showToolbar: true,
            /* 画布的大小 */
            canvasSize: [document.getElementById('fishcanvas').scrollWidth, document.body.scrollHeight - 400],
            /*  鱼头左侧中心坐标  */
        ...
        /* 依赖文件*/
        this.importJs = ["jtopo-0.4.2-min.js", "FinModel.js", "Map.js", "toolbar.js"];
...
//                            break;
            ...
            this.initMainBonePositions = function () {
                ...
                jNode.setImage(path_ + '../../images/head.png', false);
            ...
            this.initMainBone = function () {
                ...
                jNode.setImage(path_ + '../../images/body.png', false);
                jNode.zIndex = 9;
                ...
                jNodeTail.setImage(path_ + '../../images/tail.png', true);
                jNodeTail.zIndex = 10;
